...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["I hate mondays",		"Play on the worst day of the week.",						'monday_night_play',	 	false],
		["Mail delivered!",		"Beat Ayko-week.",											'weekAyko_beat',			false],
		["Gmailed'",			"Beat Ayko-week on Hard with no Misses.",					'weekAyko_nomiss',			false],
		["Back on Track",		"Beat Chill-Out",											'chill-out_hard',			false],
		["STOP CHEATING",		"Beat Cheating",											'cheating_hard',			false],
		["TOO LOUD FOR ME!!",   "Turn the volume to the minimum on the song and complite it",'too_loud',                 true]
		//later
...
class AchievementObject extends FlxSpriteGroup {
	...
	public function new(name:String, ?camera:FlxCamera = null)
	{
		...
		var achievementBG:FlxSprite = new FlxSprite(60, 50).loadGraphic(Paths.image('achievement_box'));
		...
		achievementName.setFormat(Paths.font("FolksXXHeavy.ttf"), 16, FlxColor.WHITE, LEFT);
		achievementName.scrollFactor.set();

		var achievementText:FlxText = new FlxText(achievementName.x, achievementName.y + 32, 280, Achievements.achievementsStuff[id][1], 16);
		achievementText.setFormat(Paths.font("FolksXXHeavy.ttf"), 16, FlxColor.WHITE, LEFT);
